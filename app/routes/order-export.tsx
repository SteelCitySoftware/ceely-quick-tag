...
.label-4x6 {
  ...
  padding: 0.35in; /* safe margin for most printers */
}
.label-inner {
  width: 100%;
  height: 100%;
...
@media print {
  ...
  /* Prevent scaling/cropping on many browsers */
  html, body {
    width: 4in;
    height: 6in;
    margin: 0 !important;
  ...
  /* ...except our print container */
  #print-container,
  #print-container * {
    visibility: visible !important;
  }

  /* Show the container itself during print */
  #print-container {
  ...
  /* Remove borders/padding on print labels */
  .label-4x6 {
