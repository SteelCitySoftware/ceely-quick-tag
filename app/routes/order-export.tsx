    ...
    <head>
      ...
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        .count { align-self:center; justify-self:center; font-size:30pt; font-weight:800; }
        .mixed { align-self:end; text-align:center; font-size:40pt; font-weight:900; letter-spacing:1px; }
      </style>
    </head>
    <body>${content}</body>
  </html>`;
